...
def cleanup_files():
    ...
    all_files_to_remove = OBSOLETE_TEST_FILES + OBSOLETE_RESULT_FILES + OBSOLETE_DOC_FILES
    ...
    print(f"Disk space saved: {total_size_saved:,} bytes ({total_size_saved/1024:.1f} KB)")
