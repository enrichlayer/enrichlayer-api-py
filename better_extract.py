...
def extract_endpoints_from_file(file_path):
    ...
    for section in class_sections:
        ...
        method_matches = re.finditer(r'async def (\w+)\((.*?)\) -> .*?:', section, re.DOTALL)
...
def main():
    ...
    # Save to JSON file
    output_file = Path('/home/scythx/Documents/git/vertical-int/enrich-layer/enrichlayer-py/complete_endpoints_analysis.json')
